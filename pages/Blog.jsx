    ...
    return (
        ...
        <div className="flex flex-col md:flex-row items-center md:items-center gap-6 p-6 bg-whiteLight">
            ...
            <div className="w-full md:w-2/3 text-center md:text-left order-2 md:order-1 flex flex-col justify-center">
                <h2 className="font-heading text-base text-grayMedium font-bold mb-4 ">FEATURED POSTS</h2>
                <h2 className="font-heading text-4xl font-bold mb-4 ">Step-by-step guide to choosing great font pairs.</h2>
                <h4 className='text-sm font-body font-semibold text-grayMedium mb-4'>By John Doe | May 23, 2022</h4>
    ...
    return (
        <>
            ...
            <div className='flex justify-center gap-6 my-6'>
                <div className='font-heading font-bold text-xl text-grayMedium hover:underline'>&lt; Prev</div>
                <div className='font-heading font-bold text-xl hover:underline'>Next &gt;</div>
            </div>
        </>
    )
}
...
const AllCategories = () => {
    return (
        <>
            <h2 className="text-3xl font-heading font-bold ml-6 mt-4">All Categories</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 p-4">
                {categories.map((category, index) => (
                    ...
                    >
                        ...
                        <div className="mt-16">
                            <h2 className="text-2xl font-semibold mb-2 font-heading">{category.title}</h2>
                            <p className="text-base text-grayMedium font-body">{category.description}</p>
                        </div>
                    </div>
                ))}
            </div>
